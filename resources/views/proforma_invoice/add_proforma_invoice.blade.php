                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="radio" name="invoice_type"
                                                        id="invoice_type_reg" onchange="loadDetail(0, {{ $invoice_header->id }})" value="REG" <?= (($invoice_header->reimburse_flag == '0' && $invoice_header->reimburse_flag == '0' && $invoice_header->debit_note_flag == '0' && $invoice_header->credit_note_flag == '0') ? 'checked' : '') ?>> Reguler<br>
                                                    <input type="radio" name="invoice_type"
                                                        id="invoice_type_reimbursment" onchange="loadDetail(0, {{ $invoice_header->id }})" value="REM" <?= (($invoice_header->reimburse_flag == '1') ? 'checked' : '') ?>> Reimbursment<br>
                                                    <input type="radio" name="invoice_type"
                                                        id="invoice_type_debit_note" onchange="loadDetail(0, {{ $invoice_header->id }})" value="DN" <?= (($invoice_header->debit_note_flag == '1') ? 'checked' : '') ?>> Debit Note<br>
                                                    <input type="radio" name="invoice_type"
                                                        id="invoice_type_credit_note" onchange="loadDetail(0, {{ $invoice_header->id }})" value="CN" <?= (($invoice_header->credit_note_flag == '1') ? 'checked' : '') ?>> Credit Note<br>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group date" id="proforma_invoice_date_picker"
                                                        ...
                                                        <input type="text" name="proforma_invoice_date"
                                                            ...
                                                            data-target="#proforma_invoice_date_picker" value="{{ date('d/m/Y') }}" />
