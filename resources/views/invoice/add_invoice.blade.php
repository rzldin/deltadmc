            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('invoice.save') }}" id="formInvoice">
                                @csrf
                                        ...
                                        <div class="row show_new">
                                            <div class="col-md-6">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="truck_no" id="truck_no">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                            ...
                                            <div class="col-md-5">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                            <input type="text" name="invoice_date" id="invoice_date" class="form-control datetimepicker-input" data-target="#reservationdate" />
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="mbl_shipper" id="mbl_shipper" value="{{ $booking->mbl_no }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="hbl_shipper" id="hbl_shipper" value="{{ $booking->hbl_shipper }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="m_vessel" id="m_vessel" readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="pol_name" id="pol_name" value="{{ $booking->port1 }}" readonly>
                                                        <input class="form-control" type="hidden" name="pol_id" id="pol_id" value="{{ $booking->pol_id }}">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="pod_name" id="pod_name" value="{{ $booking->port3 }}" readonly>
                                                        <input class="form-control" type="hidden" name="pod_id" id="pod_id" value="{{ $booking->pod_id }}">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
