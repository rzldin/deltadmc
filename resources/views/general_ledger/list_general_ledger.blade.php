                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form class="form-row" action="{{ route('general_ledger.index') }}" method="get">
                                <div class="col-1">
                                    <label for="currency_id">Currency</label>
                                </div>
                                <div class="col-4">
                                    <select class="form-control mb-2 select2bs44" name="currency_id" id="currency_id">
                                        @foreach ($currency as $item)
                                            <option value="{{ $item->id }}" @if ($item->id == $currency_id)
                                                selected
                                            ...
                                            @foreach ($accounts as $key => $account)
                                                <div class="card">
                                                    <div class="card-header" id="heading_{{ $key }}">
                                                        <h2 class="mb-0">
                                                            <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapse_{{ $key }}" aria-expanded="true"
                                                                aria-controls="collapse_{{ $key }}" onclick="loadDetail({{ $key }}, {{ $account->id }})">
                                                                <div class="row">
                                                                    <div class="col">
                                                        ...
                                                        <div class="card-body">
                                                            <table id="" class="table table-bordered table-striped">
                                                                ...
                                                                <tbody id="tbody_{{ $key }}" style="font-size: 14px">
                                                                    <div class="align-items-center bg-white justify-content-center spinner_load" id="spinner_{{ $key }}">
