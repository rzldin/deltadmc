                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group date" id="kas_masuk_date_picker"
                                                        ...
                                                        <input type="text" name="kas_masuk_date"
                                                            ...
                                                            data-target="#kas_masuk_date_picker" value="{{ date('d/m/Y', strtotime($header->kas_masuk_date)) }}" readonly />
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group date" id="transaction_date_picker"
                                                        ...
                                                        <input type="text" name="transaction_date" id="transaction_date"
                                                            class="form-control datetimepicker-input"
                                                            data-target="#transaction_date_picker" value="{{ date('d/m/Y', strtotime($header->kas_masuk_date)) }}"  readonly/>
