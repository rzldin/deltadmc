                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                              <input type="text" name="tanggal" id="tanggal_dt" value="@if($header->tanggal != null){{ \Carbon\Carbon::parse($header->tanggal)->format('d/m/Y') }}@else @endif" class="form-control datetimepicker-input" data-target="#reservationdate" disabled/>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                          <div class="input-group date" id="reservationdatex" data-target-input="nearest">
                              <input type="text" name="tgl_jatuh_tempo" id="tgl_jatuh_tempo" value="@if($header->tgl_jatuh_tempo != null){{ \Carbon\Carbon::parse($header->tgl_jatuh_tempo)->format('d/m/Y') }}@else @endif" class="form-control datetimepicker-input" data-target="#reservationdatex" readonly/>
