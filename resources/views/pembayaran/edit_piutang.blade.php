                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                              <input type="text" name="tanggal" id="tanggal" value="@if($header->tanggal != null){{ \Carbon\Carbon::parse($header->tanggal)->format('d/m/Y') }}@else @endif" class="form-control datetimepicker-input" data-target="#reservationdate"/>
