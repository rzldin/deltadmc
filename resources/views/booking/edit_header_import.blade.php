...
{{--         <?php if($quote->shipment_by == 'SEA') {?>
            ...
            <a href="{{ url('booking/cetak_si_fcl/'.$quote->id) }}" target="_blank" class="btn btn-danger btn-sm mr-2 float-right"><i class="fa fa-print"></i> Print SI</a>
            @else
            <a href="{{ url('booking/cetak_si_lcl/'.$quote->id) }}" target="_blank" class="btn btn-danger btn-sm mr-2 float-right"><i class="fa fa-print"></i> Print SI</a>
            @endif
        <?php }elseif($quote->shipment_by == 'AIR'){?>
            <a href="{{ url('booking/cetak_si_air/'.$quote->id) }}" target="_blank" class="btn btn-danger btn-sm mr-2 float-right"><i class="fa fa-print"></i> Print SI</a>
        <?php }?> --}}
