                    ...
                    <div class="card-body">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody style="font-size: 14px">
                                @foreach ($acc_payables as $key => $ap)
                                    <tr>
                                        <td align="center">{{ ($key + 1) }}</td>
                                        <td>{{ $ap->client_code }}</td>
                                        <td>{{ $ap->booking_no }}</td>
                                        <td>{{ $ap->invoice_no }}</td>
                                        <td>{{ date('d/m/Y', strtotime($ap->invoice_date)) }}</td>
                                        <td align="right">{{ number_format(($ap->total_invoice - $ap->invoice_bayar), 2, ',', '.') }}</td>
                                        {{-- <td></td> --}}
                                    </tr>
                                @endforeach
                            </tbody>
