...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>List Vehicle Type</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">list Vehicle Type</li>
          </ol>
        </div>
      </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ '/master/vehicleType_delete/'.$list->id }}" class="btn btn-danger btn-xs hapus-link"><i class="fa fa-trash"></i> Delete </a>
                                </td>
                            </tr>
                            @endforeach
                    </table>
    ...
    <script>
        ...
        function simpandata(){
            if($.trim($("#code").val()) == ""){
                ...
                if(dsState=="Input"){                
                    $('#formku').attr("action", "{{ route('master.vehicleType_doAdd') }}");
                    $('#formku').submit();              
                }else{
                    $('#formku').attr("action", "{{ route('master.vehicleType_doEdit') }}");
                    $('#formku').submit(); 
                }
            }
        ...
        function editData(id){
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('master.vehicleType_get') }}",
                dataType: 'json',
                data : {id: id},
