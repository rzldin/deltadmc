                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox mt-2">
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" id="np" name="np" value="1" @if ($company->np_flag == 1) checked @endif disabled>
                                                    <label for="np">
                                                        NOTIFY PARTY
                                                    </label>
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox mt-2">
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" id="consignee" name="consignee" value="1" @if ($company->consignee_flag == 1) checked @endif disabled>
                                                    <label for="consignee">
                                                        CONSIGNEE
                                                    </label>
                                                </div>
