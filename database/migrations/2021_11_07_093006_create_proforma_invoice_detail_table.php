...
class CreateProformaInvoiceDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_proforma_invoice_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('t_proforma_invoice_detail');
    }
}
